        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-size-16 text-uppercase text-white-50">المستخدمين</h5>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-size-16 text-uppercase text-white-50">الاقسام</h5>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-size-16 text-uppercase text-white-50">الوجبات</h5>
        ...
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <h5 class="font-size-16 text-uppercase text-white-50">السلايد</h5>
