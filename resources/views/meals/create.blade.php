                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="ar_components" class="form-control" name="ar_components" value="">
                            </div>

                            <div class="mb-3">
                                <label class="en_components">المكونات بالانجيلزية</label>
                                <input type="text" id="en_components" class="form-control" name="en_components" value="">
                            </div>
